...
public class CUIInventorySlot : CUIObjectBase, IComparer<CUIInventorySlot>
{
	...
	public event System.Action<int, bool, CUIInventorySlot> p_EVENT_OnPress;
	public event System.Action<int> p_EVENT_OnClick;

	public int p_iSlotIndex = 1;
	...
	public void EventSetDragDropItem()
	{
		...
		pEventTrigger.p_eInputType = CCompoEventTrigger.EInputType.OnPress;
	...
	public int Compare(CUIInventorySlot x, CUIInventorySlot y)
	{
	...
	protected override void OnUIClick()
	{
		...
		if(p_EVENT_OnClick != null)
			p_EVENT_OnClick(p_iSlotIndex);
	}
	...
	void OnDrop(GameObject pObjectDropped)
	{
