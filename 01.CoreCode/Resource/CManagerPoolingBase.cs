    ...
    where RESOURCE : Component
{
    ...
    protected EventDelegate EventMakeDelegate_Return(RESOURCE pResource)
    {
        EventDelegate pEventDelegate = new EventDelegate(this, "DoReturnResource");
        pEventDelegate.parameters[0] = new EventDelegate.Parameter(pResource);
