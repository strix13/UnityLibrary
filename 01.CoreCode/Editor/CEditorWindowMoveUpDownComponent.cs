...
public class CEditorWindowMoveUpDownComponent : EditorWindow {
    ...
    [MenuItem("Strix_Tools/MoveUpDown Component")]
    public static void DoOpen_MoveUpDownComponentr()
    {
        CEditorWindowMoveUpDownComponent windowHndle = (CEditorWindowMoveUpDownComponent)EditorWindow.GetWindow(typeof(CEditorWindowMoveUpDownComponent));
