...
public class CUIFrameLogin_CreateAccount : CNGUIPanelHasButtonBase<CUIFrameLogin_CreateAccount.EButton>
{
	...
	public override void OnClick_Buttons( EButton eButtonName )
	{
		switch (eButtonName)
		{
			case EButton.Button_Back:
				CManagerUILogin.instance.DoShowHide_Panel(CManagerUILogin.EFrame.CUIFrameLogin_Login, true);
				break;
