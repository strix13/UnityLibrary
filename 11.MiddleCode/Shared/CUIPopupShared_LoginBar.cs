...
public class CUIPopupShared_LoginBar : CNGUIPanelBase
{
	...
	protected override IEnumerator OnShowPanel_PlayingAnimation( int iSortOrder )
	{
		...
		return base.CoProcShowPanel( iSortOrder );
	}
	...
	private IEnumerator ProcShowLoginBar()
	{
		...
		yield return SCManagerYield.GetWaitForSecond(_pTweenPos.duration + 1);

		_pTweenPos.PlayReverse();
		yield return SCManagerYield.GetWaitForSecond(_pTweenPos.duration);
