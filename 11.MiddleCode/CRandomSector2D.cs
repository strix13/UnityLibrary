...
public class CRandomSector2D : CObjectBase
{
	...
	private Dictionary<int, int> _mapUseObjectID = new Dictionary<int, int>();
	...
	private Vector2 ProcCheckEmptySector(int iObjectID)
	{
		...
		if (iCount >= 100)
			Strix.Debug.Log_ForCore( Strix.EDebugLevel.Warning_Core, "ProcCheckEmptySector Loop Count > 100" );
